{
  flake.modules.nvf.telescope-file-browser = { pkgs, config, lib, options, ... }:
    let
    ...
    in
    {
      options.vim.telescope = {
        ...
        fileBrowser = mkOption {
          ...
          type = submodule {
            options = {
              enable = mkEnableOption "telescope-file-browser.nvim: file browser extension for telescope.nvim" // { default = true; };
            };
          };
        };
      };
